...
#define ualarm(x, y) gett(x, y);



void gett(useconds_t a, useconds_t){
	static time_t t;
	static time_t std_time;
	time_t d;
	if (a != 0){
		std_time = a / (TIME_FAC * 1e3);
		std::cout << std_time << " ";
		t = get_time();
	}else{
		d = get_time() - t;
		std::cout << d << " slower by: " << d*1. / std_time << " ";
		t = 0;
	}
}
...
void vector_tests(void)
{
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        for (; ft_valid_it != ft_v1.end(); ++ft_valid_it)
            ft_sit3 += *ft_valid_it;
        /*----------------------------------------------------*/
        EQUAL((s1 == ft_s1 && z1 == ft_z1 && sit1 == ft_sit1) && (s2 == ft_s2 && z2 == ft_z2) && (s3 == ft_s3 && z3 == ft_z3 && sit2 == ft_sit2) && (s4 == ft_s4 && z4 == ft_z4 && sit3 == ft_sit3));
    }
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        // insert at the begin
        {
            ...
            for (size_t i = 0; i < ft_v.size(); ++i)
                ft_str += ft_v[i];
            cond = ((str == ft_str) && (s == ft_s) && (*ft_it == *it));
        }
        // insert at the end
        {
            std::vector<std::string> v;
            ...
            for (size_t i = 0; i < ft_v.size(); ++i)
                ft_str += ft_v[i];
            cond = (cond && (str == ft_str) && (s == ft_s) && (*it == *ft_it));
        }
        /*---------------------------------------------------------------------------------------------------*/
        /*------------------------------- test 2: the vector capacity >= size + the new element ----------------------------------------*/
        {
            ...
            for (size_t i = 0; i < ft_v.size(); ++i)
                ft_str += ft_v[i];
            cond = (cond && (str == ft_str) && (s == ft_s) && (*it == *ft_it) && (&(*valid_it) == &(*ft_v.begin())));
        }
        /*---------------------------------------------------------------------------------------------------*/
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        // /*------------------------------- test 2: the vector capacity >= size + n ----------------------------------------*/
        {
            ...
            for (size_t i = 0; i < ft_v.size(); ++i)
                ft_str += ft_v[i];
            cond = (cond && (str == ft_str) && (s == ft_s) && (&(*valid_it) == &(*ft_v.begin())));
        }
        // /*---------------------------------------------------------------------------------------------------*/
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        for (size_t i = 0; i < ft_v.size(); ++i)
            ft_str += ft_v[i];
        cond = ((str == ft_str) && (s == ft_s) && (&(*valid_it) == &(*(ft_v.begin() + 99))));
